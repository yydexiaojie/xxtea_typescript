...
export function toUint8Array(v: any, includeLength: any) {
    var length = v.length;
    var n = length << 2;
    if (includeLength) {
        var m = v[length - 1];
...
export function toUint32Array(bytes: any, includeLength: any) {
...
export function mx(sum: any, y: any, z: any, p: any, e: any, k: any) {
    return ((z >>> 5 ^ y << 2) + (y >>> 3 ^ z << 4)) ^ ((sum ^ y) + (k[p & 3 ^ e] ^ z));
}

export function fixk(k: any) {
    if (k.length < 16) {
...
export function encryptUint32Array(v: any, k: any) {
    var length = v.length;
    var n = length - 1;
    var y, z, sum, e, p, q;
    z = v[n];
...
export function decryptUint32Array(v: any, k: any) {
    var length = v.length;
    var n = length - 1;
    var y, z, sum, e, p, q;
    y = v[0];
...
export function toBytes(str: any) {
    var n = str.length;
